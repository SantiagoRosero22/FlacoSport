       ...
       <div class="panel-body">
          <form method="post" action="editar_usuario.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            <div class="form-group">
                  ...
                  <input style='background-color:#f1ccbe; border-radius: 20px' type="name" class="form-control" name="name" value="<?php echo remove_junk(ucwords($e_user['name'])); ?>">
            </div>
            <div class="form-group">
                  <label for="username" class="control-label">Usuario</label>
                  <input style='background-color:#f1ccbe; border-radius: 20px' type="text" class="form-control" name="username" value="<?php echo remove_junk(ucwords($e_user['username'])); ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="status">Estado</label>
                <select style='background-color:#f1ccbe; border-radius: 20px' class="form-control" name="status">
      ...
      <div class="panel-body">
        <form action="editar_usuario.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          <div class="form-group">
                ...
                <input style='background-color:#f1ccbe; border-radius: 20px' type="password" class="form-control" name="password" placeholder="Ingresa la nueva contraseña" required>
          </div>
          <div class="form-group clearfix"  style='text-align: center'>
              <button style='width: 150px; border-radius: 20px' type="submit" name="update-pass" class="btn btn-danger">Cambiar</button>
          </div>
        </form>
      </div>
    </div>
