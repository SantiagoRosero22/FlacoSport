    ...
    <div class="panel panel-default" style='border-radius: 20px'>
      ...
      <form method="post" action="editar_grupo.php?id=<?php echo (int)$e_group['id'];?>" class="clearfix">
        <div class="form-group">
              ...
              <input style='background-color:#f1ccbe; border-radius: 20px' type="name" class="form-control" name="group-name" value="<?php echo remove_junk(ucwords($e_group['group_name'])); ?>">
        </div>
        <div class="form-group">
              <label for="level" class="control-label">Nivel del grupo</label>
              <input style='background-color:#f1ccbe; border-radius: 20px' type="number" class="form-control" name="group-level" value="<?php echo (int)$e_group['group_level']; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group clearfix"  style='text-align: center'>
                <button type="submit" name="update" class="btn btn-info" style='width: 150px; border-radius: 20px'>Actualizar</button>
        </div>
    </form>
        </div>
