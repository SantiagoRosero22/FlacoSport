    ...
    <div class="panel panel-default" style='border-radius: 20px'>
      <div class="panel-heading clearfix" style='background-color: #7ACBEE; border-radius: 20px'>
       ...
       <div class="pull-right">
          <a href="sales.php" class="btn btn-primary"style=' border-radius: 20px'>Mostrar todas las ventas</a>
        </div>
      </div>
          ...
          <th> Acciones</th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="editar_venta.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary" style='border-radius: 20px'>Editar venta</button>
                </td>
              </form>
              </tr>
           </tbody>
