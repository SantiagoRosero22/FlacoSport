       ...
       <div class="panel-body">
         <form method="post" action="editar_marca.php?id=<?php echo (int)$categorie['id'];?>">
           <div class="form-group">
               <input style='background-color:#f1ccbe; border-radius: 20px'type="text" class="form-control" name="categorie-name" value="<?php echo remove_junk(ucfirst($categorie['name']));?>">
           </div>
           <button style='width: 150px; border-radius: 20px' type="submit" name="edit_cat" class="btn btn-primary">Actualizar categoría</button>
       </form>
       </div>
     </div>
   </div>
